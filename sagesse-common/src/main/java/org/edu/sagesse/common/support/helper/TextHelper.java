...
public class TextHelper {
    private static final SaLogger LOGGER = SaLoggerFactory.getLogger(TextHelper.class);
    /**
     * 非携带变量填充占位符
     */
    ...
    public String format(String template, Map<String, Object> varMap) {
        ...
        try {
            ...
            while (matcher.find()) {
                ...
                String convertValue = Optional.ofNullable(value).map(String::valueOf).orElse(StringUtil.EMPTY);
