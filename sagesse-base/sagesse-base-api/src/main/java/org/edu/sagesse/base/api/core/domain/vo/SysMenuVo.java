...
@Setter
@Getter
public class SysMenuVo extends AbstractDataVo {
    private static final long serialVersionUID = -43150146756084220L;

    public static final SysMenuVo EMPTY = Builder.builder(SysMenuVo::new).build();
