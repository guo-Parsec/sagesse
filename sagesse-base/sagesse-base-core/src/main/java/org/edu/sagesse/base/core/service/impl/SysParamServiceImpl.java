...
public class SysParamServiceImpl implements SysParamService {
     ...
     */
    @Override
    @Cacheable(cacheNames = "sys:param:single", key = "'id:'+#id")
     ...
     */
    @Override
    @Cacheable(cacheNames = "sys:param:single", keyGenerator = "queryDtoKeyGenerator")
     ...
     */
    @Override
    @Cacheable(cacheNames = "sys:param:list", keyGenerator = "dtoKeyGenerator")
     ...
     */
    @Override
    @Caching(evict = @CacheEvict(cacheNames = {"sys:param:single", "sys:param:list"}, allEntries = true),
            cacheable = @Cacheable(cacheNames = "sys:param:single", keyGenerator = "dtoKeyGenerator"))
     ...
     */
    @Override
    @CacheEvict(cacheNames = {"sys:param:single", "sys:param:list"}, allEntries = true)
