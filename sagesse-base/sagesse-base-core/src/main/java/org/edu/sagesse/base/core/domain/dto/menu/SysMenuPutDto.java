 ...
 *
 * @author guocq
 * @since 2022-11-29 17:48:48
 */
@ApiModel(value = "系统菜单表更新参数")
@Setter
@Getter
public class SysMenuPutDto extends AbstractDataDto {
    private static final long serialVersionUID = -76521491187551036L;

    public static final SysMenuPutDto EMPTY = Builder.builder(SysMenuPutDto::new).build();
    ...
    public SysMenuPutDto() {
    }

    @Override
    public String toString() {
        return new StringJoiner(", ", SysMenuPutDto.class.getSimpleName() + "[", "]")
                .add("id=" + id)
