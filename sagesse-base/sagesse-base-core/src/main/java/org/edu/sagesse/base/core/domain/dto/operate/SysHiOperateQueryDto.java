...
/**
 * 操作历史记录表(SysHiOperate)查询参数
 *
 * @author guocq
 * @since 2022-11-29 17:46:36
 */
@ApiModel(value = "操作历史记录表查询参数")
@Setter
@Getter
public class SysHiOperateQueryDto extends AbstractDto {
    private static final long serialVersionUID = -42156757090602391L;
    
    public static final SysHiOperateQueryDto EMPTY = Builder.builder(SysHiOperateQueryDto::new).build();
    ...
    public SysHiOperateQueryDto() {
    }

    @Override
    public String toString() {
        return new StringJoiner(", ", SysHiOperateQueryDto.class.getSimpleName() + "[", "]")
                .add("id=" + id)
