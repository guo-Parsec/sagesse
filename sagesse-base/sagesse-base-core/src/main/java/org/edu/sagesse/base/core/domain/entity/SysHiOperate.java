...
@Setter
@Getter
public class SysHiOperate extends AbstractEntity {
    private static final long serialVersionUID = 511942127186675134L;
    /**
     * 访问路径
     */
    ...
    public String toString() {
        return new StringJoiner(", ", SysHiOperate.class.getSimpleName() + "[", "]")
                .add("id=" + id)
